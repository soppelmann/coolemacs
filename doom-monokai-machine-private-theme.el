;;; doom-monokai-machine-private-theme.el --- port of Monokai Classic -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-monokai-machine-private-theme nil
  "Options for doom-molokai."
  :group 'doom-themes)

(defcustom doom-monokai-machine-private-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-monokai-machine-private-theme
  :type 'boolean)

(defcustom doom-monokai-machine-private-comment-bg doom-monokai-machine-private-brighter-comments
  "If non-nil, comments will have a subtle, darker background.
Enhancing their legibility."
  :group 'doom-monokai-machine-private-theme
  :type 'boolean)

(defcustom doom-monokai-machine-private-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-monokai-machine-private
  ...
  ((bg         '("#000000" nil       nil            ))
   ...
   (orange     '("#FFD2A7" "#ff7f50" "brightred"    ))
   (green      '("#a2e57b" "#90ee90" "green"        ))
   (yellow     '("#FFFFB6" "#f0e68c" "yellow"       ))
   (violet     '("#c6c5fe" "#9370db" "magenta"      ))
   (cyan       '("#96cbfe" "#40e0d0" "brightcyan"   ))
   (magenta     cyan)
   (blue        cyan)
   (dark-blue   cyan)
   (teal        cyan)
   ...
   (selection      base2)
   (builtin        cyan)
   (comments       (if doom-monokai-machine-private-brighter-comments violet base6))
   (doc-comments   (if doom-monokai-machine-private-brighter-comments (doom-lighten violet 0.1) (doom-lighten base6 0.25)))
   (constants      violet)
   (functions      orange)
   (keywords       magenta)
   (methods        green)
   ...
   (-modeline-pad
    (when doom-monokai-machine-private-padded-modeline
      (if (integerp doom-monokai-machine-private-padded-modeline) doom-monokai-machine-private-padded-modeline 4)))
  ...
  ((cursor                                       :background fg)
   ...
   (isearch                                      :foreground yellow :weight 'bold :background base6)
...
;;; doom-monokai-machine-private-theme.el ends here
