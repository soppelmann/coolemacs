...
(defgroup leuven-private nil
  "Leuven-Private theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom leuven-private-scale-org-document-title t
...
(defcustom leuven-private-scale-outline-headlines t
...
(defcustom leuven-private-scale-org-agenda-structure t
...
(defcustom leuven-private-scale-volatile-highlight t
...
;;;###autoload
(defun leuven-private-scale-font (control default-height)
...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 `(,@(leuven-private-scale-font leuven-private-scale-outline-headlines 1.3) :weight bold :overline "#A7A7A7" :foreground "#3C3C3C" :background "#F0F0F0"))
      ...
      (volatile-highlight-supersize `(,@(leuven-private-scale-font leuven-private-scale-volatile-highlight 1.1) :underline unspecified :foreground "white" :background "#9E3699")) ; flash-region
  ...
  (custom-theme-set-faces
   ...
   `(leuven-private-org-deadline-overdue ((,class (:foreground "#F22659"))))
   `(leuven-private-org-deadline-today ((,class (:weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(leuven-private-org-deadline-tomorrow ((,class (:foreground "#40A80B"))))
   `(leuven-private-org-deadline-future ((,class (:foreground "#40A80B"))))
   `(leuven-private-gnus-unseen ((,class (:weight bold :foreground "#FC7202"))))
   `(leuven-private-gnus-date ((,class (:foreground "#FF80BF"))))
   `(leuven-private-gnus-size ((,class (:foreground "#8FBF60"))))
   `(leuven-private-todo-items-face ((,class (:weight bold :foreground "#FF3125" :background "#FFFF88"))))
   ...
   `(org-agenda-date ((,class (,@(leuven-private-scale-font leuven-private-scale-org-agenda-structure 1.6) :weight bold :foreground "#1662AF"))))
   `(org-agenda-date-today ((,class (,@(leuven-private-scale-font leuven-private-scale-org-agenda-structure 1.6) :weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(org-agenda-date-weekend ((,class (,@(leuven-private-scale-font leuven-private-scale-org-agenda-structure 1.6) :weight bold :foreground "#4E4E4E"))))
   ...
   `(org-agenda-structure ((,class (,@(leuven-private-scale-font leuven-private-scale-org-agenda-structure 1.6) :weight bold :foreground "#1F8DD6"))))
   ...
   `(org-document-title ((,class (,@(leuven-private-scale-font leuven-private-scale-org-document-title 1.8)  :weight bold :foreground "black"))))
...
(custom-theme-set-variables 'leuven-private
...
;;; leuven-private-theme.el ends here
