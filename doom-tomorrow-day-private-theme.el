;;; doom-tomorrow-day-private-theme.el --- a light variant of Tomorrow -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-tomorrow-day-private-theme nil
  "Options for the `doom-tomorrow-day-private' theme."
  :group 'doom-themes)

(defcustom doom-tomorrow-day-private-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-tomorrow-day-private-theme
...
(def-doom-theme doom-tomorrow-day-private
  ...
  ((bg         '("#ffffff" "white"   "white" ))
   ...
   (-modeline-pad
    (when doom-tomorrow-day-private-padded-modeline
      (if (integerp doom-tomorrow-day-private-padded-modeline)
          doom-tomorrow-day-private-padded-modeline
        4))))
  ...
  (((font-lock-doc-face &override) :slant 'italic)
   ...
   (tab-bar :background "#5D6B99" :foreground "#333333")
   (tab-bar-tab :background "#F5CC84" :foreground "#333333")
   (tab-bar-tab-inactive :background "#3B4F81" :foreground bg)
...
;;; doom-tomorrow-day-private-theme.el ends here
